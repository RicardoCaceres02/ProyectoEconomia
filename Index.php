                                    ...
                                    <div class="wrapper fadeInDown">
                                        <div id="formContent">
                                          ...
                                          <div class="fadeIn first">
                                            <img src="img/icon/icon.png" id="icon" alt="User Icon" />
                                          </div>
                                      
                                          <!-- Login Form -->
                                          <form method="post" action="Iniciosecion.php" >
                                            ...
                                            <input type="submit" class="fadeIn fourth" value="Registrarse"  formaction="Registro.php">
                                          </form>
