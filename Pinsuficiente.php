     ...
     <div class="container-fluid py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="display-5 mb-5">Lo sentimos El pago no se ha completado por falta de fondos</h1>
                
            </div>
            
        <div class="col-12 text-center">
                            <a href="MetodoPago.php">
                                <button class="btn btn-primary py-3 px-4" type="submit" href="RegistroTar.php">Elegir Tarjeta </button>
                            </div>
        </div>
