     ...
     <div class="container-fluid py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="display-5 mb-5">Metodo de pago</h1>
                <h1 class="display-5 mb-5">Mis tarjetas</h1>
            </div>
        ...
        <div id="contenido">
         <table style="margin: auto; width: 350px; border-collapse: separate; border-spacing: 50px 15px;">
  		        <thead>
        ...
        $sql1 = " SELECT  customer_id FROM  Clientes where customer_username='$username'";
        $resultado1 = mysqli_query($conn, $sql1);
        $fila = mysqli_fetch_assoc($resultado1);
        $idusuario=intval($fila['customer_id']);
        
        $sql2 = " SELECT numTarjeta , saldo FROM tarjeta where Idcliente=$idusuario";
        $resultado2 = mysqli_query($conn, $sql2);
       
      
        while ($filas = mysqli_fetch_assoc($resultado2)) {
        echo "<tr>";
        echo "<td>" . $filas["numTarjeta"] . "</td>";
        echo "<td>" . $filas["saldo"] . "</td>";
        echo "<td> <a href='Procesarpago.php?saldo=".$filas['saldo']."''><button type='button' class='btn btn-info'>Utilizar</button></a> </td>";
            echo "</tr>";
            }
        ...
        <div class="col-12 text-center">
                            <a href="RegistroTarjeta.php">
                                <button class="btn btn-primary py-3 px-4" type="submit" href="RegistroTar.php">Registrar tarjeta </button>
                            </div>
        </div>
